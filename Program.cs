...
static class Part2Handler
    {
        public static void Part2()
        {
            ...
            Random rnd = new Random();
            bool suckedIntoUnderpants = rnd.Next(2) == 0;
            ...
            if (suckedIntoUnderpants)
            {
                ...
                StringTyper.TypeString("What doo you do?:");
                ...
                string underpants_choice1 = Console.ReadLine();
                if (underpants_choice1 == "1")
                {
                    ...
                    string underpants_choice2 = Console.ReadLine();
                    if (underpants_choice2 == "1")
                    {
                        StringTyper.TypeString("The thong immediatly crumples, turning into a pile of imobile fabric.");
                ...
                else if (underpants_choice1 == "2")
                {
                    StringTyper.TypeString("You cry like wee little baby, bawling your eyes out.");
                    ...
                    string underpants_choice3 = Console.ReadLine();
                    if (underpants_choice3 == "1")
                    {
                        StringTyper.TypeString("You run around until you fall into the waistband river.");
                        StringTyper.TypeString("You think you've drowned when you relize that you're safe back home");
                        StringTyper.TypeString("boring ending");
                    }
                    else if (underpants_choice3 == "2")
                    {
                        StringTyper.TypeString("You cry and cry and cry and cry and cry and cry and cry and cry and cry and cry and cry and cry and cry until you die of crine");
            ...
            bool issekaied = rnd.Next(100) < 15;
    ...
    static void Part5()
    {
        ...
        {
            Random rnd = new Random();
            bool raisedByBear = rnd.Next(100) < 25; // 25% chance
