...
class Program
{
    // Global variable storing the dream weapon choice (used later in bear fight)
    ...
    static void Part1()
    {
        // Loop prevents stack overflow (replaces recursive time-travel deaths)
        while (true)
        {
            // Opening narrative
    ...
    static void Part2()
    {
        while (true)
        {
            ...
            //Profanity check
            if (yell.Contains("Fuck", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Shit", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Bitch", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("crap", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Poop", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("God Dammit", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Darn", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Gosh Dangit", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("Gadzooks", StringComparison.OrdinalIgnoreCase) ||
                yell.Contains("God Damn It", StringComparison.OrdinalIgnoreCase))
            {
            ...
            while (true)
            {
                ...
                //Instructs player to keep their pants on
                else if (dodge_choice == "3")
                {
                    ...
                    // Advance to dream weapon section
                    Part3();
                    return;
                }
                else
    ...
    // Utility pause function used throughout game
